namespace TERSApplication.Web.Resources
{
    using System;
    ...
    internal static class ClientCultureBasedResources
    {
        ...
        ///    'TERSApplication-culture' cookie (which gets set by the Siverlight ASPX
        ///    wrapper, see TERSApplicationTestPage.aspx). If there is no such
        ...
        private static CultureInfo CurrentCulture
        {
            get
            {
                string clientCulture = HttpContext.Current.Request.Cookies["TERSApplication-culture"].Value;
